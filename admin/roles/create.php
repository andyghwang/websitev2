            ...
            <div class="admin-container">
                <form class="sm-box admin-form" action="" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="title" id="title" class="input-control" placeholder="Role Name...">
                    </div>
                    <!-- Description -->
                    <div class="input-group">
                        <label for="description">Description</label>
                        <textarea name="description" class="input-control" rows="7" placeholder="Description of role..."></textarea>
                    </div>
                    <!-- Create -->
                    <div class="input-group">
